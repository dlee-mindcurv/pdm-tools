---
name: pdm-ralph-loop
description: "Agent instructions for each PDM Ralph iteration. Implements one user story from prd.json, runs quality checks, updates status, and signals completion when all stories pass."
---

# PDM Ralph Loop - Single Iteration Agent Instructions

This skill defines the behavior for a single PDM Ralph iteration. Each iteration implements ONE user story from prd.json.
...
| Browser | pdm-webapp-testing skill | UI stories with browser verification criterion |
